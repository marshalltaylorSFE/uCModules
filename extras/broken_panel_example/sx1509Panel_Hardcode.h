...
#ifndef sx1509Panel_Hardcode_H
#define sx1509Panel_Hardcode_H
...
public:
	...
	volatile uint8_t * volatile inputCachePointers[16];
	volatile uint8_t * volatile outputCachePointers[16];
	uint8_t nullValue;
	uint16_t portDir;
	uint16_t portPU;
